...
uint128_t::uint128_t() : UPPER(0), LOWER(0) {}
...
uint128_t &uint128_t::operator++() { return *this += uint128_1; }
...
uint128_t uint128_t::operator+() const { return *this; }

uint128_t uint128_t::operator-() const { return ~*this + uint128_1; }
